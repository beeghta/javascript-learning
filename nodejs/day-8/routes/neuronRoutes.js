...
import { getAllNeurons, getNeuronById, getFiringNeurons, getNeuronStatus, createNeuron, updateNeuron, deleteNeuron, testError, searchNeurons } from "../controllers/neuronController.js";
...
router.get("/search", searchNeurons);
